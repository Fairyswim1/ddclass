// Last Redeploy Trigger: 2026-03-18 11:30 (ROOT DEPLOYMENT FIX)
...
app.get('/', (req, res) => {
    res.json({
        message: 'DDClass Server is running (Root Level)',
        version: '1.0.4',
...
app.use((req, res) => {
    ...
    res.status(404).json({ success: false, message: `Route ${req.method} ${req.url} not found on server (Root Level)` });
});
