...
const LATEX_GROUPS = [
    ...
    },
    {
        ...
        symbols: [
            ...
            { label: '[]', insert: '\\left[ \\right]' },
            { label: '{}', insert: '\\left\\{ \\right\\}' },
            { label: '2×2행렬', insert: '\\begin{pmatrix} a & b \\\\ c & d \\end{pmatrix}' },
            { label: '행렬식', insert: '\\det\\begin{pmatrix} a & b \\\\ c & d \\end{pmatrix}' },
            { label: '조건식', insert: '\\begin{cases}  &  \\\\  &  \\end{cases}' },
            { label: '줄정렬', insert: '\\begin{aligned}  &=  \\\\  &=  \\end{aligned}' },
            { label: '이항계수', insert: '\\binom{n}{k}' },
